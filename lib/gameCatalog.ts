...
export const GAMES: GameCatalogEntry[] = [
  ...
  // Live Casino & Original Table Games
  {
    slug: "dragon_tiger",
    label: "Dragon Tiger",
    description: "Live Dragon vs Tiger card game",
    href: "/dragon-tiger/1m",
    category: "live",
    popular: true,
    badge: "HOT",
    emoji: "🐉",
  },
  {
    ...
    description: "Live dealer Blackjack 21",
    href: "/blackjack",
    category: "live",
    popular: true,
    badge: "NEW",
  ...
  },
  {
    slug: "baccarat",
    label: "Baccarat Live",
    description: "Punto Banco Live Baccarat",
    href: "/baccarat",
    category: "live",
    popular: true,
    badge: "NEW",
  ...
  },
  {
    slug: "sicbo",
    label: "Sic Bo Live",
    description: "Live 3-dice shaker game",
    href: "/sicbo",
    category: "live",
    popular: false,
    emoji: "🎲",
  },
  {
    slug: "seven_up_down",
    label: "7 Up Down",
    description: "Dice sum prediction 7 UP, 7, 7 DOWN",
    href: "/seven-up-down",
    category: "originals",
    popular: true,
    badge: "HOT",
  ...
  {
    slug: "teen_patti",
    label: "Teen Patti Live",
    description: "3-card Indian Poker against Dealer",
    href: "/teen-patti",
    category: "live",
    popular: true,
    badge: "NEW",
